// https://github.com/JiepengTan/Lockstep.Serializer
...
namespace Lockstep.Serialization {
    ...
    public partial class Serializer {
        ...
        public void Write(List<float> value){_PutList(value, sizeof(float), FastBitConverter.GetBytes);}

        public void Write(List<double> value){_PutList(value, sizeof(double), FastBitConverter.GetBytes);}

        public void Write(List<long> value){_PutList(value, sizeof(long), FastBitConverter.GetBytes);}

        public void Write(List<ulong> value){_PutList(value, sizeof(ulong), FastBitConverter.GetBytes);}

        public void Write(List<int> value){_PutList(value, sizeof(int), FastBitConverter.GetBytes);}

        public void Write(List<uint> value){_PutList(value, sizeof(uint), FastBitConverter.GetBytes);}

        public void Write(List<ushort> value){_PutList(value, sizeof(ushort), FastBitConverter.GetBytes);}

        public void Write(List<short> value){_PutList(value, sizeof(short), FastBitConverter.GetBytes);}

        public void Write(List<bool> value){_PutList(value, sizeof(bool), FastBitConverter.GetBytes);}

        public void Write(List<LFloat> value){_PutList(value, sizeof(long), FastBitConverter.GetBytes);}
        ...
        public void Write(LQuaternion val){Write(val.x);Write(val.y);Write(val.z);Write(val.w);}
        public void Write(LVector2Int val){Write(val.x);Write(val.y);}
        ...
        private void _PutList<T>(List<T> value, int typeSize, Action<byte[], int, T> _func) where T : struct{
